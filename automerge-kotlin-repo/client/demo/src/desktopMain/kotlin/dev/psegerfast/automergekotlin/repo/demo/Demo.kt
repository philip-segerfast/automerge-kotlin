...
//            }
//
//            // Collect entire document.proto updates.
//            docRef.collectChanges { document.proto ->
//
//            }
//
...
//    /** Get document.proto, either from a remote connection or local storage. */
//    suspend fun getDocument(actorId: ActorId): KDocument
//    /** Save document.proto to a remote connection or local storage. */
//    suspend fun saveDocument(document.proto: KDocument)
...
//) : TypedDocument() {
//
//    private lateinit var document.proto: KDocument
//
//    private val textNodeId = "text"
//
//    private val delegator = DocumentDelegator(document.proto)
//
//    val text: ElementRef.Text = textReference()
//
//    init {
//        val value = document.proto[KObjectId.ROOT, textNodeId] as KAmValue.Text
//        value.stringValue()
//    }
//
//    override fun free() {
...
//            return (document.proto.get(objectId, key) as KAmValue.Text).stringValue()
