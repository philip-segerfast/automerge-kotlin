...
actual operator fun KDocument.Companion.invoke(actorId: ByteArray?): KDocument =
    if(actorId == null) KDocumentImpl() else KDocumentImpl(actorId)
...
) : KDocument, KReadable by KReadDelegate(document) {
