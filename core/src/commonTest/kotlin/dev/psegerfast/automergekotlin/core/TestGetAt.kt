...
internal class TestGetAt : AnnotationSpec() {
    internal interface TestCase {
        ...
        fun get(r: KRead): KAmValue

        fun getAt(r: KRead, heads: Array<KChangeHash>): KAmValue
    }
    ...
    fun testGetAtInMap() {
        run(object : TestCase {
            ...
            override fun get(r: KRead): KAmValue {
                return r[KObjectId.Companion.ROOT, "key"]!!
            }

            override fun getAt(r: KRead, heads: Array<KChangeHash>): KAmValue {
