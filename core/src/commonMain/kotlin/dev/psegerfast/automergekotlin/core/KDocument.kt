...
expect operator fun KDocument.Companion.invoke(): KDocument

expect operator fun KDocument.Companion.invoke(actorId: ByteArray): KDocument

interface KDocument : KRead {
