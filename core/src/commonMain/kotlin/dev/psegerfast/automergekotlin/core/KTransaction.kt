...
interface KWrite {
     ...
     * if the object is not a map
     */
    operator fun set(parent: KObjectId, key: String, objType: KObjectType): KObjectId
     ...
     */
    operator fun set(parent: KObjectId, index: Long, objType: KObjectType): KObjectId
...
interface KTransaction : KRead, KWrite, AutoCloseable {
